...
rule metaspades:
    input:
        R1=rules.generate_metaspades_input.output.R1,
        R2=rules.generate_metaspades_input.output.R2,
        se=rules.generate_metaspades_input.output.se,
    output:
        results + "/assembly/{assembly}/final_contigs.fa",
    log:
...
rule megahit:
    input:
        ...
        R2=rules.generate_megahit_input.output.R2,
        se=rules.generate_megahit_input.output.se,
    output:
        results + "/assembly/{assembly}/final_contigs.fa",
    log:
