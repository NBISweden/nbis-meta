#!/domus/h1/john/git/scilifelab-lts/nbis-meta/.snakemake/conda/1903dcda/bin/python
"""
...
if __name__ == "__main__":
    ...
    "End Position and SubContig ID' respectively. The Subcontig ID is usually the same as the Contig ID for contigs "
    "which are not cutup. This file can be generated by the cut_up_fasta.py script.")
